...
134 plots
```{r}
#TODO : automatic reading
seed <- data.table::fread("/run/user/1001/gvfs/smb-share:server=ipssmonstera.unibe.ch,share=planteco/DATA/BE_Synthesis/BetaDivMultifun/raw_data/24966_Arthropod mediated processes (dung and seed depletion) measured on all EPs in 2017_1.4.12/24966.txt")
