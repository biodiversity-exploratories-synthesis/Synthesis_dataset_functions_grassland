...
```{r}
nce <- raw_functions[,c("Plotn", "DEA","nifH", "nxrA_NS", "16S_NB")]
# invert DEA measure to nitrate production and availability
nce[, "nitrate.production.availability" := DEA * -1]
nce[, "DEA" := NULL]
